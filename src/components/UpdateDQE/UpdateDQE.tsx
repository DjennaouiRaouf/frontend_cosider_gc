...
import {hideEditDQE} from "../Slices/EditModalSlices";
...
const UpdateDQE: React.FC<UpdateDQEProps> = ({refresh}) => {
    ...
    const { showEditDQEForm } = useSelector((state: RootState) => state.editDataModalReducer);

    const dispatch = useDispatch();
    const [formData, setFormData] = useState<any>(showEditDQEForm.state);
      useEffect(() => {
        setFormData(showEditDQEForm.state);
      }, [showEditDQEForm]);
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showEditDQEForm.shown} onHide={handleClose} size={"xl"}>
              <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Modifier le DQE {showEditDQEForm.id}</Modal.Title>
        </Modal.Header>
                  <Modal.Body>
                          ...
                          <div className="card shadow mb-3 bg-body-tertiary ">
                              <div className="card-body bg-body-tertiary ">
                                  ...
                                  <div className="row" style={{marginBottom: 25, textAlign: "left"}}>
                                      {showEditDQEForm.fields.map((field: any, index: any) => (
