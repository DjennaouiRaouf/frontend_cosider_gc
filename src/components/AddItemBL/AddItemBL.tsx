 ...
 */
  ...
  return (
      <>
         <Modal show={showAddBLItemForm.shown} onHide={handleClose} size={"xl"}>
              <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Ajouter au Bon de livraison N°{showAddBLItemForm.id}</Modal.Title>
        </Modal.Header>
                  <Modal.Body>
